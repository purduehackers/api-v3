/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 82c9edb7ec82f934ca7a4e6768ad3d1d)
// Runtime types generated with workerd@1.20260317.1 2026-03-17 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Discord" | "Doorbell" | "Phonebell" | "Sign";
	}
	interface Env {
		ATTENDANCE_DB: D1Database;
		CLOUDFLARE_ACCOUNT_ID: string;
		CLOUDFLARE_DATABASE_ID: string;
		CLOUDFLARE_D1_TOKEN: string;
		PHONE_API_KEY: string;
		DISCORD_API_KEY: string;
		DOOR_OPENER_API_KEY: string;
		SIGN_PROVISION_KEY: string;
		DSAI_SIGN_API_KEY: string;
		BIDC_SIGN_API_KEY: string;
		DISCORD_ACTOR: DurableObjectNamespace<import("./src/index").Discord>;
		DOORBELL_ACTOR: DurableObjectNamespace<import("./src/index").Doorbell>;
		PHONEBELL_ACTOR: DurableObjectNamespace<import("./src/index").Phonebell>;
		SIGN_ACTOR: DurableObjectNamespace<import("./src/index").Sign>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_DATABASE_ID" | "CLOUDFLARE_D1_TOKEN" | "PHONE_API_KEY" | "DISCORD_API_KEY" | "DOOR_OPENER_API_KEY" | "SIGN_PROVISION_KEY" | "DSAI_SIGN_API_KEY" | "BIDC_SIGN_API_KEY">> {}
}
